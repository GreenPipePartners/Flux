...
VALID_COMP_CARD_MODES = {"summary", "detail", "configure"}
...
def comp_card_mode(request, card_id: str, default: str = "summary") -> str:
    ...
    if default not in VALID_COMP_CARD_MODES:
        default = "summary"
...
def comp_card_controls(card_id: str, current_mode: str, modes: str = "summary,detail,configure"):
    ...
    available_modes = [mode for mode in requested_modes if mode in VALID_COMP_CARD_MODES]
