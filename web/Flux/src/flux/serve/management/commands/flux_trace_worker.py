...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        if options["nav_well_live"]:
            from flux.chart.providers.nav_wells import seeded_well_profiles, sync_nav_well_plane_samples, update_nav_well_live_values
            ...
            def job():
                ...
                questdb_points = export_plane_samples_to_questdb(profile_keys=[profile.key for profile in profiles])
