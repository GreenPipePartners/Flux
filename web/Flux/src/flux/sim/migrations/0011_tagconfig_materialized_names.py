...
def sync_materialized_tag_names(apps, schema_editor):
    ...
    for field_tag in field_tags:
        ...
        TagConfig.objects.filter(
            ...
            materialized=True,
        ).update(tag_name=field_tag.name)


class Migration(migrations.Migration):

    dependencies = [
        ("sim", "0010_tagconfig_base_tag_fk_enabled"),
    ]

    operations = [
        migrations.RunPython(sync_materialized_tag_names, migrations.RunPython.noop),
    ]
