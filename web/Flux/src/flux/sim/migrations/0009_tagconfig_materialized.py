...
def mark_materialized_tags(apps, schema_editor):
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddIndex(
            model_name="tagconfig",
            index=models.Index(fields=["sim_device", "materialized", "enabled"], name="sim_tag_materialized_idx"),
        ),
        migrations.RunPython(mark_materialized_tags, migrations.RunPython.noop),
    ]
